...
void ADC_DMA_Config(void)
{
  ...
  ADC_RegularChannelConfig(ADC1, ADC_Channel_0, 1, ADC_SampleTime_96Cycles);
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_5, 6, ADC_SampleTime_96Cycles);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_6, 7, ADC_SampleTime_96Cycles);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_7, 8, ADC_SampleTime_96Cycles);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_14, 9, ADC_SampleTime_96Cycles);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_15, 10, ADC_SampleTime_96Cycles);
...
int main(void)
{
	...
	send_uart("cusik svete2!!");	
	//ADC_DMA_Config();
	
//	DATA_EEPROM_Unlock();
//	DATA_EEPROM_FastProgramByte(0x08082000, 0x53);
